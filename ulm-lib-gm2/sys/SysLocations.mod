(* Ulm's Modula-2 Library
   ...
   ----------------------------------------------------------------------------
   $Id: SysLocations.mod,v 1.2 2005/11/21 12:09:59 gaius Exp $
   ----------------------------------------------------------------------------
   $Log: SysLocations.mod,v $
   ...
   Revision 0.2  1997/02/28  15:47:46  borchert
   header fixed
...
IMPLEMENTATION MODULE SysLocations;
