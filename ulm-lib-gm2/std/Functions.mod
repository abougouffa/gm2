(* Ulm's Modula-2 Library
   ...
   ----------------------------------------------------------------------------
   $Id: Functions.mod,v 1.5 2005/11/22 15:13:20 gaius Exp $
   ----------------------------------------------------------------------------
   $Log: Functions.mod,v $
   Revision 1.5  2005/11/22 15:13:20  gaius
   ...
   * tidied up some ulm implementation modules in ulm-lib-gm2/std
   ...
   Revision 0.2  1997/02/28  15:50:07  borchert
   header fixed
...
(*
 * Local variables:
 *  compile-command: "gm2 -c -g -I../sys:. Functions.mod"
 * End:
 *)
