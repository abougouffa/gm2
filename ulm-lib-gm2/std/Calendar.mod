(* Ulm's Modula-2 Library
   ...
   ----------------------------------------------------------------------------
   $Id: Calendar.mod,v 1.7 2005/11/22 15:13:20 gaius Exp $
   ----------------------------------------------------------------------------
   $Log: Calendar.mod,v $
   Revision 1.7  2005/11/22 15:13:20  gaius
   fixed Copyright dates

   Revision 1.6  2005/11/21 12:09:59  gaius
   ...
   * implemented nested module within procedures.
   ...
   Revision 0.2  1997/02/28  15:49:50  borchert
   header fixed
