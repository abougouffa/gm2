...
It originated from p2c-1.20 another GNU Project "p2c" file: src/funcs.c
*/
...
Static Expr *func_iaddress(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    return makeexpr_cast(func_addr(NULL), tp_integer);
}


Static Expr *func_addtopointer(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2, *ex3;
    Type *type, *tp2;
...
Static Expr *func_blockread(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Expr *func_blockwrite(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2, *vex, *sex, *fex;
    Type *type;
...
Static Stmt *proc_blockread(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_blockwrite(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2, *vex, *rex, *fex;
    Type *type;
...
Static Expr *func_bytewrite(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2, *vex, *sex, *fex;
    Type *type;
...
Static Expr *func_byte_offset(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Type *tp;
    Meaning *mp;
...
Static Stmt *proc_move_fast(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2, *ex3, *ex4;
...
Static Stmt *proc_randomize(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    if (*randomizename)
...
Static Stmt *proc_setstrlen(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2;
...
Static Stmt *proc_settextbuf(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *fex, *bex, *sex;
...
Static Stmt *proc_strappend(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *ex2;
...
Static Stmt *proc_strdelete(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_strinsert(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Meaning *tvari;
    Expr *exs, *exd, *exi;
...
Static Expr *func_val_modula (arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex;
    Type *tp;
...
Static Stmt *proc_val_turbo(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_writecard(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_writereal(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_overprint(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
...
Static Stmt *proc_strwrite(spbase)
Stmt *spbase;
{
    Expr *vex, *exi, *exj, *ex;
    Stmt *sp;
...
Static Stmt *proc_str_turbo(arg)
     Expr *arg ATTRIBUTE_UNUSED;
{
    Expr *ex, *wid, *prec;
