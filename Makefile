...
tmake_file= ./config/t-linux ./config/i386/t-crtstuff
...
all.indirect: Makefile ../cc1gm2

# IN_GCC tells obstack.h that we are using gcc's <stddef.h> file.
INTERNAL_CFLAGS = $(CROSS) -DIN_GCC -DUSE_CPPLIB -DGM2
...
compiler: ../cc1gm2
../cc1gm2: $(GM2_OBJS) $(GCC_PATCHED) $(GCC_OBJDEPS) $(LIBDEPS) gccgm2
	echo $(CC) $(ALL_CFLAGS) $(LDFLAGS) -o ../cc1gm2 \
	      $(GM2_OBJS) $(GM2_LIBS) $(GCC_OBJS) $(LIBS)
	$(CC) $(ALL_CFLAGS) $(LDFLAGS) -o ../cc1gm2 \
	      $(GM2_OBJS) $(GM2_LIBS) $(GCC_OBJS) $(LIBS)

Makefile: $(srcdir)/Makefile.in $(srcdir)/../configure
	cd ..; $(SHELL) config.status

native: config.status ../cc1gm2
...
parse.o : parse.c $(CONFIG_H) $(TREE_H)

$(srcdir)/parse.c: $(srcdir)/parse.y
	cd $(srcdir); $(BISON) $(BISONFLAGS) -o parse.c parse.y

gm2.o : gm2.c $(CONFIG_H) $(TREE_H) ../flags.h
