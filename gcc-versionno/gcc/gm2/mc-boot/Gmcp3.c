/* automatically created by mc from gm2/gm2-auto/mcp3.mod.  */
...
void _M2_mcp3_init (int argc, char *argv[])
{
}

void _M2_mcp3_finish (int argc, char *argv[])
{
}
