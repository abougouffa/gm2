/* automatically created by mc from ../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod.  */
  ...
  if (o < h)
    {
      ...
      AddDebugInfo ((*c).next);
      (*c).next = AssignDebug ((*c).next, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 714, (char *) "ConcatContents", 14);
    }
  else
    (*c).len = i;
}
  ...
  if (j < h)
    {
      ...
      AddDebugInfo ((*c).next);
      if (TraceOn)
        (*c).next = AssignDebug ((*c).next, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 909, (char *) "ConcatContentsAddress", 21);
    }
  else
    {
      (*c).len = i;
...
DynamicStrings_String DynamicStrings_InitString (char *a_, unsigned int _a_high)
{
  ...
  AddDebugInfo (s);
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 750, (char *) "InitString", 10);
  return s;
}
...
DynamicStrings_String DynamicStrings_InitStringCharStar (void * a)
{
  ...
  AddDebugInfo (s);
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 949, (char *) "InitStringCharStar", 18);
  return s;
}
...
DynamicStrings_String DynamicStrings_InitStringChar (char ch)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 969, (char *) "InitStringChar", 14);
  return s;
}
...
DynamicStrings_String DynamicStrings_Dup (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1165, (char *) "Dup", 3);
  return s;
}
...
DynamicStrings_String DynamicStrings_Add (DynamicStrings_String a, DynamicStrings_String b)
{
  ...
  if (TraceOn)
    a = AssignDebug (a, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1185, (char *) "Add", 3);
  return a;
}
...
unsigned int DynamicStrings_EqualCharStar (DynamicStrings_String s, void * a)
{
  ...
  if (TraceOn)
    t = AssignDebug (t, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1250, (char *) "EqualCharStar", 13);
  t = AddToGarbage (t, s);
...
unsigned int DynamicStrings_EqualArray (DynamicStrings_String s, char *a_, unsigned int _a_high)
{
  ...
  if (TraceOn)
    t = AssignDebug (t, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1280, (char *) "EqualArray", 10);
  t = AddToGarbage (t, s);
  if (DynamicStrings_Equal (t, s))
    {
      t = DynamicStrings_KillString (t);
...
DynamicStrings_String DynamicStrings_Mult (DynamicStrings_String s, unsigned int n)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1312, (char *) "Mult", 4);
  return s;
}
...
DynamicStrings_String DynamicStrings_Slice (DynamicStrings_String s, int low, int high)
{
              ...
              if (t->contents.next == NULL)
                {
                  ...
                  if (TraceOn)
                    t->contents.next = AssignDebug (t->contents.next, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1380, (char *) "Slice", 5);
                }
              t = t->contents.next;
            }
  ...
  if (TraceOn)
    d = AssignDebug (d, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1397, (char *) "Slice", 5);
  return d;
}
...
DynamicStrings_String DynamicStrings_RemoveComment (DynamicStrings_String s, char comment)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1509, (char *) "RemoveComment", 13);
  return s;
}
...
DynamicStrings_String DynamicStrings_RemoveWhitePrefix (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1621, (char *) "RemoveWhitePrefix", 17);
  return s;
}
...
DynamicStrings_String DynamicStrings_RemoveWhitePostfix (DynamicStrings_String s)
{
  ...
  if (TraceOn)
    s = AssignDebug (s, (char *) "../../gcc-versionno/gcc/gm2/gm2-libs/DynamicStrings.mod", 55, 1643, (char *) "RemoveWhitePostfix", 18);
  return s;
}
