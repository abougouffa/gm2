...
changequote([, ])dnl
    ...
    ac_shtool="${CONFIG_SHELL-/bin/sh} $ac_srcdir/libpth/pth/shtool"
    ...
    $3_STR="`$ac_shtool version -lc -dlong $ac_srcdir/libpth/pth/$4`"
    AC_SUBST($3_STR)
    ...
    $3_HEX="`$ac_shtool version -lc -dhex $ac_srcdir/libpth/pth/$4`"
    AC_SUBST($3_HEX)
fi
])dnl
