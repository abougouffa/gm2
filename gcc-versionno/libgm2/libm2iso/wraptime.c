...
struct timeval *wraptime_InitTimeval (void)
{
  return (struct timeval *) malloc (sizeof (struct timeval));
}
#else
void *wraptime_InitTimeval (void)
{
  return NULL;
}
#endif
...
struct timeval *wraptime_KillTimeval (void *tv)
{
#if defined(HAVE_MALLOC_H)
  free (tv);
#endif
...
#else
void *wraptime_InitTimezone (void)
{
  return NULL;
}
#endif
...
struct tm *wraptime_InitTM (void)
{
  return (struct tm *) malloc (sizeof (struct tm));
}
#else
void *wraptime_InitTM (void)
{
  return NULL;
}
#endif
...
struct tm *wraptime_KillTM (struct tm *tv)
{
#if defined(HAVE_MALLOC_H)
  free (tv);
#endif
...
int wraptime_gettimeofday (void *tv, struct timezone *tz)
{
  return gettimeofday (tv, tz);
}
#else
int wraptime_gettimeofday (void *tv, void *tz)
{
  return -1;
}
#endif
...
int wraptime_settimeofday (void *tv, struct timezone *tz)
{
  return settimeofday (tv, tz);
}
#else
int wraptime_settimeofday (void *tv, void *tz)
{
  return -1;
}
#endif
...
/*
 *  wraptime_GetFractions - returns the tv_usec field inside the timeval structure.
 */

#if defined(HAVE_TIMEVAL)
unsigned int wraptime_GetFractions (struct timeval *tv)
{
  return (unsigned int) tv->tv_usec;
}
#else
unsigned int wraptime_GetFractions (void *tv)
{
...
unsigned int wraptime_GetYear (struct tm *m)
{
  return m->tm_year;
}
#else
unsigned int wraptime_GetYear (void *m)
{
  return (unsigned int)-1;
}
#endif
...
#if defined(HAVE_STRUCT_TM)
unsigned int wraptime_GetMonth (struct tm *m)
{
  return m->tm_mon;
}
#else
unsigned int wraptime_GetMonth (void *m)
{
  return (unsigned int)-1;
}
#endif
...
#if defined(HAVE_STRUCT_TM)
unsigned int wraptime_GetDay (struct tm *m)
{
  return m->tm_mday;
}
#else
unsigned int wraptime_GetDay (void *m)
{
  return (unsigned int)-1;
}
#endif
...
#if defined(HAVE_STRUCT_TM)
unsigned int wraptime_GetHour (struct tm *m)
{
  return m->tm_hour;
}
#else
unsigned int wraptime_GetHour (void *m)
{
  return (unsigned int)-1;
}
#endif
...
#if defined(HAVE_STRUCT_TM)
unsigned int wraptime_GetMinute (struct tm *m)
{
  return m->tm_min;
}
#else
unsigned int wraptime_GetMinute (void *m)
{
  return (unsigned int)-1;
}
#endif
...
/*
 *  wraptime_GetSecond - returns the seconds in the minute from the structure, m.
...
#else
unsigned int wraptime_GetSecond (void *m)
{
  return (unsigned int)-1;
}
#endif
...
unsigned int wraptime_GetSummerTime (struct timezone *tz)
{
  return tz->tz_dsttime != 0;
}
#else
unsigned int wraptime_GetSummerTime (void *tz)
{
  return FALSE;
}
#endif
...
#else
void wraptime_SetTimezone (void *tz,
			   int zone, int minuteswest)
{
}
#endif
...
void _M2_wraptime_init() {}
void _M2_wraptime_finish() {}
